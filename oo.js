...
model Post {
  ...
  publicId    String?
  catName     String?
  category    Category? @relation(fields: [catName], references: [categName])
  author      User?      @relation(fields: [authorEmail], references: [id])
  authorEmail String? @db.Uuid
  links       String[]
      ...
      <div className="pt-12 space-y-10">
        ...
        <div className="relative h-full w-full">
          <LexicalComposer initialConfig={initialConfig}>
            <PlainTextPlugin
              contentEditable={
                <ContentEditable className="h-full w-full min-h-44 p-4 border " />
              }
              placeholder={
                <div className="absolute top-4 left-4">Enter some text...</div>
              }
