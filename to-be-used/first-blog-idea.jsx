/**
 * v0 by Vercel.
 * @see https://v0.dev/t/TLjdiQ1Povo
...
export default function Component() {
  return (
    <div className="bg-gray-100 dark:bg-gray-850">
      <div className="py-6 md:py-12 lg:py-16 xl:py-24">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Master the art of baking with our comprehensive guide to making the perfect loaf of bread.
                </p>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <div className="text-sm font-medium leading-none">
                  ...
                  <span className="block text-gray-500 dark:text-gray-400">August 24, 2023</span>
                </div>
              </div>
            </div>
            <Link className="md:col-span-2 flex items-center space-x-4 rounded-lg overflow-hidden" href="#">
              <img
                alt="Cover image"
