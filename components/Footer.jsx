...
export default function Footer() {
  ...
  return (
    <footer className="pb-16 text-white bg-blue-600">
      {/* <div className="mx-auto w-full max-w-screen-2xl  py-16  lg:px-12 sm:px-6 px-4"> */}
      <div className="container   py-16  sm:px-6 px-4">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3  md:gap-8 gap-4">
          ...
          <div className="sm:ml-0 ml-8 flex gap-8  lg:gap-14 xl:gap-20">
            <div className="">
      ...
      <div className="pt-14">
        <p className="text-sm leading-none mt-4 text-center dark:text-white">
          Copyright © 2021 Luxe / All rights reserved
        </p>
      </div>
    </footer>
  );
