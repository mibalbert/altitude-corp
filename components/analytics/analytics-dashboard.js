...
const Badge = ({ percentage }) => {
    ...
    const positiveClassname = 'bg-green-100 text-green-600 ring-green-600'
    const neutralClassname = 'bg-zinc-100 text-zinc-600 ring-zinc-600'
    const negativeClassname = 'bg-red-100 text-red-600 ring-red-600'
