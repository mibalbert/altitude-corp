...
const PeaceOfMind = ({ data }) => {
  ...
  return (
    <section className="py-24    bg-white overflow-hidden">
      <div className="w-full flex flex-wrap xl:items-center space-y-10 lg:space-y-0 max-w-7xl mx-auto ">
        <div className="w-full md:w-1/2 px-10 lg:px-0 lg:pr-10">
        ...
        <div className="w-full md:w-1/2  px-10 lg:px-5 space-y-10">
