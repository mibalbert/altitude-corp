...
export function ContactUsHero() {
  return (
    <section className=" w-full  h-[calc(100vh-3.5rem)]  flex flex-col md:items-center md:justify-center bg-blue-600 antialiased bg-grid-white/[0.3] relative overflow-hidden">
